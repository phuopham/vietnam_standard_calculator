    ...
    <>
      <header className='container'>
        <div className="py-3 flex gap-3">
          <Link to="/" className=" text-emerald-600 font-bold [&.active]:underline flex-1 ">
            Vietnam standard calculator
          </Link>
          <Link to="/data" className="[&.active]:font-bold">
            About data
          </Link>
          <Link to='/qna' className='[&.active]:font-bold border-s ps-3'>Q&A</Link>
        </div>
      </header>
      <hr />
      ...
      <footer className=' container flex py-3 gap-3 items-center '>
        ...
        <a href="https://github.com/phuopham"><Github /></a>
